...
# ─────────────────────────────────────────────────────────────────────────────
# FULL CLASSICAL SBC 9×9 GRID LAYERS (Phase 1)
# ─────────────────────────────────────────────────────────────────────────────
SBC_GRID_CELLS = {
    # Outer Ring - 28 Nakshatras (already correct)
    (0, 1): ("nak", "Shravana"),
    (0, 2): ("nak", "U.Ashadha"),
    (0, 3): ("nak", "P.Ashadha"),
    (0, 4): ("nak", "Moola"),
    ...
    (2, 0): ("nak", "U.Ashadha"),
    (1, 0): ("nak", "P.Ashadha"),
    # Middle Ring - Rashis (12 Zodiac Signs)
    (1, 1): ("rashi", "Leo"),
    (1, 2): ("rashi", "Virgo"),
    (1, 3): ("rashi", "Libra"),
    (1, 4): ("rashi", "Scorpio"),
    ...
    (7, 1): ("rashi", "Capricorn"),
    (7, 7): ("rashi", "Aquarius"),
    # Innermost Ring - Tithis & Varas (simplified classical labels)
    (4, 4): ("center", "Centre"),
    (3, 4): ("tithi", "Panchami"),
    (4, 3): ("tithi", "Ashtami"),
    (4, 5): ("tithi", "Navami"),
